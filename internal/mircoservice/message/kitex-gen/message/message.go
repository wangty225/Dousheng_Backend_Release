...
type MessageServiceChatMessageArgs struct {
	Req *DouyinMessageChatRequest `thrift:"req,1,required" frugal:"1,required,DouyinMessageChatRequest" json:"req"`
}
...
func (p *MessageServiceChatMessageArgs) SetReq(val *DouyinMessageChatRequest) {
	p.Req = val
}
...
func (p *MessageServiceChatMessageArgs) Field1DeepEqual(src *DouyinMessageChatRequest) bool {
...
func (p *MessageServiceChatMessageResult) Field0DeepEqual(src *DouyinMessageChatResponse) bool {
...
type MessageServiceActionMessageArgs struct {
	Req *DouyinMessageActionRequest `thrift:"req,1,required" frugal:"1,required,DouyinMessageActionRequest" json:"req"`
}
...
func (p *MessageServiceActionMessageArgs) SetReq(val *DouyinMessageActionRequest) {
	p.Req = val
}
...
func (p *MessageServiceActionMessageArgs) Field1DeepEqual(src *DouyinMessageActionRequest) bool {
...
func (p *MessageServiceActionMessageResult) Field0DeepEqual(src *DouyinMessageActionResponse) bool {
