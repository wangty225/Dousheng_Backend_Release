...
func (p *User) fastWriteField6(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	if p.IsSetAvator() {
		offset += bthrift.Binary.WriteFieldBegin(buf[offset:], "avator", thrift.STRING, 6)
		offset += bthrift.Binary.WriteStringNocopy(buf[offset:], binaryWriter, *p.Avator)
...
func (p *User) field6Length() int {
	l := 0
	if p.IsSetAvator() {
		l += bthrift.Binary.FieldBeginLength("avator", thrift.STRING, 6)
		l += bthrift.Binary.StringLengthNocopy(*p.Avator)
