...
service VideoService {
    DouyinFeedResponse Feed(1:required DouyinFeedRequest req)
    DouyinPublishActionResponse ActionPublish(1:required DouyinPublishActionRequest req)
    DouyinPublishListResponse ListPublish(1:required DouyinPublishListRequest req)
}