...
service MessageService {
    DouyinMessageChatResponse ChatMessage(1:required DouyinMessageChatRequest req)
    DouyinMessageActionResponse ActionMessage(1:required DouyinMessageActionRequest req)
}