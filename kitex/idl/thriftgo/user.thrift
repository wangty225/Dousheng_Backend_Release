...
/* ============== 4. define services:================= */
service UserService {
    DouyinUserResponse User(1:required DouyinUserRequest req)
    DouyinUserRegisterResponse RegisterUser(1:required DouyinUserRegisterRequest req)
    DouyinUserLoginResponse LoginUser(1:required DouyinUserLoginRequest req)
}
