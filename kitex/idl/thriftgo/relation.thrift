...
//    // 辅助方法，用于返回 baseUser 的 name 属性 todo: correct to use
//    user.User getUser() {
//        return baseUser;
//    }
}
...
service RelationService {
    DouyinRelationActionResponse ActionRelation(1:required DouyinRelationActionRequest req)
    DouyinRelationFollowListResponse ListFollowRelation(1:required DouyinRelationFollowListRequest req)
    DouyinRelationFollowerListResponse ListFollowerRelation(1:required DouyinRelationFollowerListRequest req)
    DouyinRelationFriendListResponse ListFriendRelation(1:required DouyinRelationFriendListRequest req)
}