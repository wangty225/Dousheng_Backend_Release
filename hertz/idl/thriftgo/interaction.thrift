namespace go interaction_hertz
include "user.thrift"
...
service InteractionService {
    DouyinFavoriteActionResponse ActionFavorite(1:required DouyinFavoriteActionRequest req) (api.post="/douyin/favorite/action/");
    DouyinFavoriteListResponse ListFavorite(1:required DouyinFavoriteListRequest req) (api.get="/douyin/favorite/list/");
    DouyinCommentActionResponse ActionComment(1:required DouyinCommentActionRequest req) (api.post="/douyin/comment/action/");
    DouyinCommentListResponse ListComment(1:required DouyinCommentListRequest req) (api.get="/douyin/comment/list/");
}